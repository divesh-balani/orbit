export const recordScreenMacContent = {
	...
	heroTLDR:
		"Want to record your Mac screen with internal audio without expensive software? Here's how to do it in 2 clicks with Orbit—completely free, no audio routing hacks needed.",
	...
	methods: [
		{
			title: "Method 1: Orbit (2-Click Tutorial)",
			description:
				"Orbit makes it ridiculously simple to record your Mac screen with system audio:",
			steps: [
				{
				...
				},
				{
					...
					content: `
            <ol>
              <li>Click the Orbit icon in your menu bar</li>
              <li>Toggle "No System Audio" to "Record System Audio"</li>
              <li>Select the screen area you want to capture</li>
              <li>Click "Start Recording"</li>
            </ol>
            <p>That's it! Orbit now captures both your screen and all system audio without any complex setup.</p>
            <p><strong>Pro Tip:</strong> Orbit works without kernel extensions and is fully compatible with macOS Sonoma and all M-series chips.</p>
          `,
				},
				{
            ...
            <p>After recording:</p>
            <ul>
              <li>Trim unwanted sections with Orbit's built-in editor</li>
		...
		},
		{
            ...
            <p><strong>Skip the hacks and try Orbit instead</strong> — no audio configuration required.</p>
          `,
				},
			],
		},
		...
		items: [
			{
				...
				answer:
					'This typically happens when both microphone and system audio are being recorded. In Orbit, make sure only "Record System Audio" is enabled if you don\'t need microphone input.',
			},
			{
				question: "My microphone is muted during system audio recording",
				answer:
					"Orbit allows recording both system audio and microphone simultaneously. Toggle both options ON in the recording menu.",
			},
			{
				question: "FaceTime/Zoom audio isn't being captured",
				answer:
					'Some apps have special privacy protections. In Orbit, make sure to select "Record entire screen" to capture protected app audio.',
			},
			{
				question: "System audio recording stopped working after update",
				answer:
					"After macOS updates, you may need to re-authorize screen recording permissions. Go to System Preferences → Security & Privacy → Privacy → Screen Recording and ensure Orbit is checked.",
			},
		],
	},
		...
		tips: [
			{
				...
				description:
					"Enable high frame rate recording in Orbit settings for smoother demos of animations and transitions.",
			},
			{
			...
			},
			{
				...
				description:
					"Use Orbit.link or set up your own custom domain for a branded sharing experience.",
			},
		],
	},
	...
	videoDemo: {
		...
		videoSrc: "https://orbit.link/video/system-audio-demo.mp4",
		caption: "Orbit recording Mac screen with system audio in 2 clicks",
	},
	...
	faqs: [
		{
			...
			answer:
				"Yes, Orbit is fully optimized for all Apple Silicon chips, including M1, M2, and M3 series processors.",
		},
		{
			question: "Will recording system audio affect my computer's performance?",
			answer:
				"Orbit is designed to be extremely lightweight. You'll experience minimal performance impact even when recording high-resolution screens with system audio.",
		},
		{
			question: "Can I record specific application audio only?",
			answer:
				"Currently, macOS doesn't provide an API for app-specific audio capture. Orbit records all system audio, but you can easily edit out unwanted sections afterward.",
		},
		{
			question: "Is there a time limit for recordings with system audio?",
			answer:
				"Orbit's free version has no time limits on recordings. Record as long as you need.",
		},
		{
			question: "Can I record system audio on multiple monitors?",
			answer:
				"Yes, Orbit can record system audio while capturing a single monitor, multiple monitors, or just a portion of your screen.",
		},
	],
	cta: {
		title: "Start Recording with System Audio Today",
		description:
			"Orbit makes recording your Mac screen with system audio incredibly simple. No complex audio routing, no expensive software.",
		buttonText: "Download Orbit",
		buttonLink: "/download",
		subtitle:
			"Download Orbit for macOS – free forever • Open-source • 14-day Pro trial",
	},
