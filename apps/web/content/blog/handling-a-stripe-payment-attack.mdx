...
description: How we handled an unexpected Stripe payment attack during Orbit's Product Hunt launch, and what we learnt from it.
...
A couple of days ago, we launched Orbit on Product Hunt, confident we were prepared for anything.
