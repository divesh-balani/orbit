...
export default function DashboardInner({
	...
	return (
		<div className="flex overflow-hidden w-full flex-col flex-1 md:mt-0 mt-[126px]">
			...
			>
				{/* Top orbit: renders rounded corner and top/side borders without affecting scroller */}
				<div
					aria-hidden
					className="h-0 rounded-tl-xl border border-b-0 pointer-events-none lg:h-2 bg-gray-2 border-gray-3"
				/>
				{/* Scrolling content area shares border/background; top border removed to meet orbit */}
