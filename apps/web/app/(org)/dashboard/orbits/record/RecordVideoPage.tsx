...
export const RecordVideoPage = () => {
	...
	const openDesktop = useCallback(() => {
		...
		window.location.href = "orbit-desktop://";
					...
					<div className="mx-auto w-full max-w-[560px] min-w-0">
						<div className="flex flex-col items-center">
							<p className="max-w-md text-gray-10 text-md">
								Choose how you'd like to record your Orbit
							</p>
						</div>
	...
	const items = [
		{
			id: "what-is-orbit",
			q: "What is an Orbit?",
			a: "An Orbit is a quick video recording of your screen, camera, or both that you can share instantly with a link.",
		},
		{
			id: "how-it-works",
			q: "How does it work?",
		...
		},
		{
			...
			a: "On compatible browsers, selecting a camera opens a picture‑in‑picture window that’s captured when you record fullscreen. We recommend recording fullscreen to keep it on top. If PiP capture isn’t supported, your camera stays within the Orbit recorder tab.",
		},
		{
		...
		},
		{
			...
			a: "Browsers limit system‑wide audio capture. We recommend using Orbit Desktop for best results.",
		},
		{
			id: "install",
			q: "Do I need to install the app?",
			a: `No. You can record in your browser. For longer recordings, system audio, and advanced editing, use Orbit Desktop. The Free plan supports up to ${freeMinutes} minutes per recording in the browser.`,
		},
	];
