...
const REMEMBER_DEVICES_KEY = "orbit-web-recorder-remember-devices";
const PREFERRED_CAMERA_KEY = "orbit-web-recorder-preferred-camera";
const PREFERRED_MICROPHONE_KEY = "orbit-web-recorder-preferred-microphone";
const SYSTEM_AUDIO_ENABLED_KEY = "orbit-web-recorder-system-audio";
