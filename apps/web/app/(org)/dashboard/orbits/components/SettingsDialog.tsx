...
const options: {
...
}[] = [
	{
		...
		description: "Allow viewers to comment on this orbit",
	},
	{
	...
	},
	{
		...
		description: "Allow viewers to use captions for this orbit",
	},
	{
	...
	},
	{
		...
		description: "Allow viewers to react to this orbit",
	},
	{
...
export const SettingsDialog = ({
	...
	const saveHandler = async () => {
		...
		try {
			...
			await updateVideoSettings(orbitId, payload);
	...
	return (
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="max-w-md min-w-fit">
				<DialogHeader
					description="Manage the settings for this orbit"
