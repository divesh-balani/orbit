...
interface OrbitCardAnalyticsProps {
	orbitId: string;
	displayCount: number;
...
export const OrbitCardAnalytics = Object.assign(
	({
		orbitId,
		displayCount,
		totalComments,
		...
		isLoadingAnalytics,
		isOwner = true,
	}: OrbitCardAnalyticsProps) =>
		isLoadingAnalytics ? (
			<OrbitCardAnalytics.Skeleton />
		) : (
			<Shell>
				<div className="flex flex-wrap gap-4 items-center">
					...
					>
						<Link
							href={`/dashboard/analytics?orbitId=${orbitId}`}
