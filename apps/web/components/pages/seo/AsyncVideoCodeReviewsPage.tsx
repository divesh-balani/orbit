...
export const asyncVideoCodeReviewsContent: SeoPageContent = {
	...
	description:
		"Record your screen, walk through pull requests and diffs, and share a timestamped video link your team can watch on their own schedule. Orbit makes async code reviews faster, clearer, and calendar-free.",

	badge: "Code Reviews",

	featuresTitle: "Everything You Need for Async Video Code Reviews",
	featuresDescription:
		"Orbit gives engineering teams a faster way to give and receive code feedback — no scheduled calls, no back-and-forth in PR comments",

	features: [
		{
			title: "Record Any PR or Diff Walkthrough",
			description:
				"Open your IDE, point your camera at the diff, and talk through your feedback in real time. Orbit records your screen and webcam simultaneously so reviewers see exactly what you see — cursor movements, code highlights, and all. No more writing long PR comments that take longer to read than a 90-second video.",
		},
		{
			title: "Instant Shareable Link — No Upload Wait",
			description:
				"Stop recording and Orbit generates a shareable link immediately. Paste it into your PR comment, Slack message, or Linear ticket. Reviewers click the link and the video plays in their browser — no app install, no login required on their end.",
		},
		{
		...
		},
		{
			...
			description:
				"Syntax highlighting, font rendering, and editor themes are captured at full fidelity. Orbit records at up to 4K resolution and 60fps so reviewers can pause the video and read every line of code clearly — even on smaller screens.",
		},
		{
		...
		},
		{
			...
			description:
				"Orbit auto-generates captions for every recording using AI transcription. Team members who prefer to read, are in a noisy environment, or speak English as a second language can follow along without audio. Captions are searchable so reviewers can jump to the part they need.",
		},
		{
		...
		},
		{
			...
			description:
				"Orbit links are just URLs — paste them anywhere your team already works. Drop a Orbit link in your GitHub PR description, GitLab MR comment, Linear issue, or Jira ticket. No integration setup, no webhooks, no OAuth.",
		},
	],
	...
	comparisonTitle: "Why Engineering Teams Choose Orbit for Code Reviews",
	comparisonDescription:
		"Async video code reviews cut context-switching and make feedback more precise — here's how Orbit compares",

	comparison: [
		{
			title: "Orbit vs Loom for Code Reviews",
			description:
				"Loom is a capable async video tool but limits recording length and quality on its free plan, and stores all video on Loom's servers with no self-hosting option. Orbit records at 4K with no recording-length limits in Studio Mode and supports <a href='/self-hosted-screen-recording'>self-hosted S3 storage</a> for teams with data residency requirements. Orbit is also MIT-licensed and fully open source.",
		},
		{
			title: "Orbit vs Written PR Comments",
			description:
				"Written PR comments are slow to compose and easy to misread. A 2-minute Orbit recording replaces a wall of inline comments — reviewers see the exact context you're referring to, hear your tone, and understand intent without the ambiguity of text. Video feedback also reduces the back-and-forth clarification round trips that slow code review cycles.",
		},
		{
			title: "Orbit vs Zoom or Google Meet for Code Reviews",
			description:
				"Synchronous video calls require scheduling across time zones, force reviewers to be present at a specific time, and produce recordings that aren't easily linked, timestamped, or commented on. Orbit gives you the clarity of a face-to-face walkthrough with the flexibility of async — reviewers watch when it suits them and leave timestamped comments.",
		},
		{
			title: "Orbit for Distributed Engineering Teams",
			description:
				"Teams spread across multiple time zones struggle to schedule live code reviews. Orbit lets the author record a walkthrough asynchronously and share a link in the PR. Reviewers in any time zone watch the video at their own pace, leave timestamped comments, and the cycle continues without anyone waiting on a meeting invite. <a href='/solutions/remote-team-collaboration'>See how distributed teams use Orbit</a>.",
		},
	],

	useCasesTitle: "How Engineering Teams Use Async Video Code Reviews",
	useCasesDescription:
		"From quick PR walkthroughs to deep architecture reviews, Orbit fits into every stage of the engineering feedback cycle",
	...
	migrationGuide: {
		title: "How to Start Doing Async Video Code Reviews with Orbit",
		steps: [
			...
			"Click the Orbit icon in your menu bar and choose Instant Mode for quick reviews or Studio Mode for longer walkthroughs",
			"Start recording — Orbit captures your screen and webcam simultaneously",
			"Talk through your feedback naturally as you scroll through the code",
			"Stop recording to get an instant shareable link",
			"Paste the Orbit link into your PR comment, Slack message, or Linear ticket",
	...
	faqs: [
		...
		},
		{
			...
			answer:
				"Orbit generates a shareable link the moment you stop recording — no upload wait, no file attachment, no third-party viewer required. Paste the link into your PR and reviewers can watch immediately. Timestamped comments let reviewers leave feedback at specific points in the video, keeping discussion organized without cluttering the PR comment thread.",
		},
		{
			question:
				"Does Orbit work with GitHub, GitLab, Linear, and other developer tools?",
			answer:
				"Yes. Orbit produces a standard URL that you can paste anywhere. Drop the link in a GitHub PR description or comment, a GitLab MR, a Linear issue, a Jira ticket, or a Slack message. No integration or webhook setup required — the link opens in any browser and the video plays without requiring the viewer to install Orbit.",
		},
		{
			question: "Can I record code in 4K so reviewers can read it clearly?",
			answer:
				"Yes. Orbit records at up to 4K resolution at 60fps, which means syntax highlighting, font rendering, and fine UI details are captured at full fidelity. Reviewers can pause the video and read any line of code clearly, even on high-DPI displays.",
		},
		{
		...
		},
		{
			...
			answer:
				"Yes. Orbit supports password protection on individual recordings and expiry dates on share links. For teams with stricter data requirements, Orbit supports self-hosted S3 storage so recording files stay within your own infrastructure and never touch Orbit's servers.",
		},
		{
			question: "What is the best tool for async video code reviews?",
			answer:
				"Orbit is the best tool for async video code reviews for engineering teams that want 4K quality, instant shareable links, timestamped commenting, and the option to self-host recordings. It's free, open-source under the MIT license, and available for Mac and Windows. Unlike general async video tools, Orbit's instant-mode and studio-mode workflows are optimized for the review cycle engineers actually use.",
		},
	],
	...
	video: {
		...
		alt: "Orbit async video code review demo showing screen recording of a pull request walkthrough with timestamped comments",
	},
