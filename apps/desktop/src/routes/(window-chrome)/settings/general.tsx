			...
			<div class="p-4 space-y-6">
				...
				{ostype === "macos" && (
					<SettingGroup title="App">
						<ToggleSettingItem
							...
							description="Show Orbit in the dock even when there are no windows available to close."
							value={!settings.hideDockIcon}
							onChange={(v) => handleChange("hideDockIcon", !v)}
						/>
						<ToggleSettingItem
							label="Enable system notifications"
							description="Show system notifications for events like copying to clipboard, saving files, and more. You may need to manually allow Orbit access via your system's notification settings."
				...
				<SettingGroup title="Recording">
					...
					<SelectSettingItem
						...
						description="Should Orbit reopen after deleting an in progress recording?"
		...
		<div class="flex flex-col gap-3 px-4 py-3 mt-6 rounded-xl border border-gray-3 bg-gray-2">
			<div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
				<div class="flex flex-col gap-1">
					...
					<p class="text-xs text-gray-10">
						Choose which windows Orbit hides from your recordings.
					</p>
					<Show when={props.isWindows}>
						<p class="text-xs text-gray-9">
							<span class="font-medium text-gray-11">Note:</span> Only Orbit
