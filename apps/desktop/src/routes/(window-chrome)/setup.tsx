...
const permissions = [
	{
		...
		description:
			"Add Orbit in System Settings, then restart the app for changes to take effect.",
	...
	},
	{
		...
		description:
			"During recording, Orbit collects mouse activity locally to generate automatic zoom in segments.",
	...
	const openSettings = async (permission: OSPermission) => {
		...
		if (permission === "screenRecording") {
			const shouldRestart = await ask(
				"After adding Orbit in System Settings, you'll need to restart the app for the permission to take effect.",
				{
		...
		<div class="flex flex-col px-[2rem] text-[0.875rem] font-[400] flex-1 bg-gray-1 justify-evenly items-center">
			...
			<Show when={currentStep() === "permissions"}>
				<div class="flex flex-col items-center">
					...
					<p class="text-gray-11">Orbit needs permissions to run properly.</p>
				</div>
			...
			<Show when={currentStep() === "mode"}>
				<div class="flex flex-col items-center">
					...
					<p class="text-gray-11">
						Choose how you want to record with Orbit. You can change this later.
					</p>
				</div>
