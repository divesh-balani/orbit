...
impl CapWindowId {
    ...
    pub fn title(&self) -> String {
        match self {
            Self::Setup => "Orbit Setup".to_string(),
            Self::Settings => "Orbit Settings".to_string(),
            Self::WindowCaptureOccluder { .. } => "Orbit Window Capture Occluder".to_string(),
            Self::CaptureArea => "Orbit Capture Area".to_string(),
            Self::RecordingControls => "Orbit Recording Controls".to_string(),
            Self::Editor { .. } => "Orbit Editor".to_string(),
            Self::ScreenshotEditor { .. } => "Orbit Screenshot Editor".to_string(),
            Self::ModeSelect => "Orbit Mode Selection".to_string(),
            Self::Camera => "Orbit Camera".to_string(),
            Self::RecordingsOverlay => "Orbit Recordings Overlay".to_string(),
            Self::TargetSelectOverlay { .. } => "Orbit Target Select".to_string(),
            _ => "Orbit".to_string(),
        }
    }
