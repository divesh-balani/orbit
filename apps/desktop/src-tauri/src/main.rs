...
fn main() {
    ...
    let file_appender = tracing_appender::rolling::daily(&logs_dir, "orbit-desktop.log");
        ...
        let tracer = opentelemetry_sdk::trace::SdkTracerProvider::builder()
            ...
            .with_resource(
                opentelemetry_sdk::Resource::builder()
                    .with_service_name("orbit-desktop")
                    .build(),
            )
            .build();

        let layer = tracing_opentelemetry::layer()
            .with_tracer(tracer.tracer("orbit-desktop"))
            .boxed();
